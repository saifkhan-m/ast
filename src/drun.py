...
te_data=f'../egs/dlr/data/datafiles/dlr_eval_data.json'
tr_data=f'../egs/dlr/data/datafiles/dlr_train_data.json'
args.model='ast'
args.dataset='dlr'
...
args.fstride=10
args.tstride=10
base_exp_dir = f'../egs/dlr/exp/test-{args.dataset}-f{args.fstride}-t{args.tstride}-p-b{args.batch_size}-lr{args.lr}'
args.save_model =True
args.n_class=4
args.label_csv= '../egs/dlr/data/dlr_class_label.csv'
...
if args.model == 'ast':
    ...
    norm_stats = {'dlr': [-9.0797,5.6859]} #############
    target_length = {'audioset':1024, 'esc50':512, 'speechcommands':128, 'dlr':512}
    # if add noise for data augmentation, only use for speech commands
    noise = {'audioset': False, 'esc50': False, 'speechcommands':True, 'dlr': False}
